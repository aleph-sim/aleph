...
[docs/perf/qec-q1-mwpm.md](docs/perf/qec-q1-mwpm.md); the Sparse Blossom
rewrite itself is tracked in [#331](https://github.com/aleph-sim/aleph/issues/331)
and not yet done). aleph's iterative BP-family decoders (`bp-osd`, `relay-bp`,
