...
- Edition: **2021**. Minimum Rust: **1.89** (raised from 1.85 in P1-03 to enable AVX-512 intrinsics, which were stabilised in Rust 1.89.0; previous bumps: 1.75 → 1.85 in P0-04 for criterion 0.5's transitive deps).
