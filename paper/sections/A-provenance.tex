...
\midrule
\S2 The decoder & \texttt{perf/qec-q5-gross.md}; \texttt{perf/qec-q5-circuit-dem.md}; \texttt{perf/qec-q7-fixed-bp.md}; \texttt{perf/qec-q5-qldpc.md}; \texttt{perf/qec-q5-bposd.md}; \texttt{perf/data/qec-q7-fixed-bp.csv}; \texttt{perf/data/qec-q7-budget.csv} \\[2pt]
...
\S6 Limitations & \texttt{perf/q7-02-asap7-timing.md}; \texttt{qec/open-silicon-program.md}; \texttt{perf/q7-02-b3-asap7-fullparallel.md}; \texttt{perf/qec-q7-fixed-bp.md}; \texttt{qec/q7-07-nonconvergence-policy.md}; \texttt{perf/q7-02-ngroup-sweep.md} \\[2pt]
