...
statistics, the non-convergence rate. Ordered-statistics decoding (OSD-0) on the flagged shots cuts
the logical error rate 4--24$\times$, but at $\approx$\SI{1.5}{\milli\second} per flagged shot it is a
host-side escalation, not a real-time fallback. The full-parallel 144/864 geometry decodes in 543 cycles; it places and routes at
